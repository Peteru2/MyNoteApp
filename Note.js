...
function showNotes() {
  ...
  notesObj.forEach((iteem, index) => {
      word += `<div class="note">
        <div><strong>${iteem.Top.Dat}</strong></div>
...
function editNote(index) {
  ...
  addtitle.value = note.Top.mainTitle;
  addtxt.value = note.text;
  // notesObj.findIndex((iteem, index) => {
  //   // iteem.preventDefault()
  //   console.log(index);
  //   console.log(iteem)
  //   addtitle.value = iteem.title.mainTitle;
  //   addtxt.value = iteem.text;
